...
import es.pmg.jhipster.config.audit.AuditEventConverter;
import es.pmg.jhipster.domain.PersistentAuditEvent;
...
import static es.pmg.jhipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
