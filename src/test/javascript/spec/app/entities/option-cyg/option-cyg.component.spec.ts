...
import { OptionCygComponent } from 'app/entities/option-cyg/option-cyg.component';
...
describe('Component Tests', () => {
  describe('OptionCyg Management Component', () => {
    let comp: OptionCygComponent;
    let fixture: ComponentFixture<OptionCygComponent>;
    let service: OptionCygService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [CygTestModule],
        declarations: [OptionCygComponent],
        providers: [
          {
        ...
        .overrideTemplate(OptionCygComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(OptionCygComponent);
